...
| `LLM_SELECTABLE_MODELS` | `gemini-3.5-flash,google/gemma-4-31b-it:free,google/gemma-4-26b-a4b-it:free,nvidia/nemotron-nano-9b-v2:free` | Curated model dropdown (comma-separated) |
